...
const COMMON_PLUGINS = [new DefinePlugin({'process.env.CLIENT_ID': `'${process.env.CLIENT_ID}'`}), new DefinePlugin({'process.env.SERVER': `'${process.env.SERVER}'`}), new DefinePlugin({'process.env.CLIENT_PWD': `'${process.env.CLIENT_PWD}'`})]
