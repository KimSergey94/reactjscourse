...
app.get('/auth', function (req, res) {
    ...
    axios_1.default.post('https://www.reddit.com/api/v1/access_token', "grant_type=authorization_code&code=" + req.query.code + "&redirect_uri=" + process.env.SERVER + "/auth", {
        auth: { username: 'undefined', password: process.env.CLIENT_PWD },
...
function Preview(props) {
    return (react_1.default.createElement("div", { className: preview_less_1.default.preview },
        react_1.default.createElement("img", { className: preview_less_1.default.previewImg, src: props.imgSrc })));
}
    ...
    return (react_1.default.createElement("div", { className: textcontent_less_1.default.textContent },
        react_1.default.createElement("div", { className: textcontent_less_1.default.metaData },
            react_1.default.createElement("div", { className: textcontent_less_1.default.userLink },
                react_1.default.createElement("img", { className: textcontent_less_1.default.avatar, src: props.imgLink, alt: "avatar" }),
...
function UserBlock(_a) {
    ...
    var hrefUrl = "https://www.reddit.com/api/v1/authorize?client_id=" + 'undefined' + "&response_type=code&state=random_string&redirect_uri=" + process.env.SERVER + "/auth&duration=permanent&scope=read submit identity";
