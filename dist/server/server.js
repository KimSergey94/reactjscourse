...
/***/ "./src/shared/CardsList/Card/TextContent/Title/title.less":
/*!****************************************************************!*\
  !*** ./src/shared/CardsList/Card/TextContent/Title/title.less ***!
  \****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n// Exports\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({\n\t\"title\": \"title__title--TUU9E\",\n\t\"postLink\": \"title__postLink--jyMVe\"\n});\n\n\n//# sourceURL=webpack://reactjscourse/./src/shared/CardsList/Card/TextContent/Title/title.less?");
...
eval("\r\nvar __importDefault = (this && this.__importDefault) || function (mod) {\r\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\r\n};\r\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\r\nexports.Menu = void 0;\r\nvar react_1 = __importDefault(__webpack_require__(/*! react */ \"react\"));\r\nvar Dropdown_1 = __webpack_require__(/*! ../../../Dropdown */ \"./src/shared/Dropdown/index.ts\");\r\nvar Icon_1 = __webpack_require__(/*! ../../../Icons/Icon */ \"./src/shared/Icons/Icon.tsx\");\r\nvar menu_less_1 = __importDefault(__webpack_require__(/*! ./menu.less */ \"./src/shared/CardsList/Card/Menu/menu.less\"));\r\nfunction Menu(props) {\r\n    var _a, _b;\r\n    function toggleCardDropdown(cardId) {\r\n        var temp = Object.assign({}, cardMenuOpened);\r\n        //if(!cardMenuOpened.cards[cardId]) temp.cards[cardId] = {cardId: cardId, isOpened: true}\r\n        //else if(cardMenuOpened.cards[cardId]) temp.cards[cardId].isOpened = !temp.cards[cardId].isOpened;\r\n        if (temp.cards) {\r\n            temp.cards.map(function (x) {\r\n                if (x.cardId === props.cardId) {\r\n                    console.log('props.cardId', props.cardId, x.isOpened);\r\n                    x.isOpened = !x.isOpened;\r\n                }\r\n                else\r\n                    x.isOpened = false;\r\n            });\r\n        }\r\n        setCardMenuOpened(temp);\r\n        console.log(111, cardMenuOpened);\r\n    }\r\n    function isCardMenuOpened(cardId) {\r\n        var _a;\r\n        console.log(222, cardMenuOpened);\r\n        if ((_a = cardMenuOpened === null || cardMenuOpened === void 0 ? void 0 : cardMenuOpened.cards[cardId]) === null || _a === void 0 ? void 0 : _a.isOpened)\r\n            return true;\r\n        return false;\r\n    }\r\n    var _c = react_1.default.useState({ cards: (_b = (_a = props.cards) === null || _a === void 0 ? void 0 : _a.cards) !== null && _b !== void 0 ? _b : [] }), cardMenuOpened = _c[0], setCardMenuOpened = _c[1];\r\n    return (react_1.default.createElement(\"div\", { className: menu_less_1.default.menu, id: \"menu\" + props.cardId },\r\n        react_1.default.createElement(\"div\", { className: menu_less_1.default.container },\r\n            react_1.default.createElement(\"div\", { onClick: function () { return toggleCardDropdown(props.cardId); } },\r\n                react_1.default.createElement(\"button\", { className: menu_less_1.default.menuButton },\r\n                    react_1.default.createElement(Icon_1.Icon, { size: 20, name: Icon_1.EIconName.MenuIcon }))),\r\n            react_1.default.createElement(\"div\", { id: \"dropdown\" + props.cardId }, isCardMenuOpened(props.cardId) && (react_1.default.createElement(Dropdown_1.Dropdown, { cardId: props.cardId }))))));\r\n}\r\nexports.Menu = Menu;\r\n\n\n//# sourceURL=webpack://reactjscourse/./src/shared/CardsList/Card/Menu/Menu.tsx?");
...
eval("\r\nvar __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {\r\n    if (k2 === undefined) k2 = k;\r\n    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });\r\n}) : (function(o, m, k, k2) {\r\n    if (k2 === undefined) k2 = k;\r\n    o[k2] = m[k];\r\n}));\r\nvar __setModuleDefault = (this && this.__setModuleDefault) || (Object.create ? (function(o, v) {\r\n    Object.defineProperty(o, \"default\", { enumerable: true, value: v });\r\n}) : function(o, v) {\r\n    o[\"default\"] = v;\r\n});\r\nvar __importStar = (this && this.__importStar) || function (mod) {\r\n    if (mod && mod.__esModule) return mod;\r\n    var result = {};\r\n    if (mod != null) for (var k in mod) if (k !== \"default\" && Object.prototype.hasOwnProperty.call(mod, k)) __createBinding(result, mod, k);\r\n    __setModuleDefault(result, mod);\r\n    return result;\r\n};\r\nvar __importDefault = (this && this.__importDefault) || function (mod) {\r\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\r\n};\r\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\r\nexports.Title = void 0;\r\nvar react_1 = __importStar(__webpack_require__(/*! react */ \"react\"));\r\nvar Post_1 = __webpack_require__(/*! ../../../../Post */ \"./src/shared/Post/index.ts\");\r\nvar title_less_1 = __importDefault(__webpack_require__(/*! ./title.less */ \"./src/shared/CardsList/Card/TextContent/Title/title.less\"));\r\nfunction Title() {\r\n    var _a = (0, react_1.useState)(false), isModalOpened = _a[0], setIsModalOpened = _a[1];\r\n    return (react_1.default.createElement(\"h2\", { className: title_less_1.default.title, onClick: function () { return console.log('clicked'); } },\r\n        react_1.default.createElement(\"a\", { href: '#post-url', className: title_less_1.default.postLink, onClick: function () { return setIsModalOpened(true); } }, \"\\u0421\\u043B\\u0435\\u0434\\u0443\\u0435\\u0442 \\u043E\\u0442\\u043C\\u0435\\u0442\\u0438\\u0442\\u044C, \\u0447\\u0442\\u043E \\u043D\\u043E\\u0432\\u0430\\u044F \\u043C\\u043E\\u0434\\u0435\\u043B\\u044C \\u043E\\u0440\\u0433\\u0430\\u043D\\u0438\\u0437\\u0430\\u0446\\u0438\\u043E\\u043D\\u043D\\u043E\\u0439 \\u0434\\u0435\\u044F\\u0442\\u0435\\u043B\\u044C\\u043D\\u043E\\u0441\\u0442\\u0438 \\u0421\\u043B\\u0435\\u0434\\u0443\\u0435\\u0442 \\u043E\\u0442\\u043C\\u0435\\u0442\\u0438\\u0442\\u044C, \\u0447\\u0442\\u043E \\u043D\\u043E\\u0432\\u0430\\u044F \\u043C\\u043E\\u0434\\u0435\\u043B\\u044C \\u043E\\u0440\\u0433\\u0430\\u043D\\u0438\\u0437\\u0430\\u0446\\u0438\\u043E\\u043D\\u043D\\u043E\\u0439 \\u0434\\u0435\\u044F\\u0442\\u0435\\u043B\\u044C\\u043D\\u043E\\u0441\\u0442\\u0438\"),\r\n        isModalOpened && (react_1.default.createElement(\"div\", null,\r\n            react_1.default.createElement(Post_1.Post, { onClose: function () { setIsModalOpened(false); } })))));\r\n}\r\nexports.Title = Title;\r\n\n\n//# sourceURL=webpack://reactjscourse/./src/shared/CardsList/Card/TextContent/Title/Title.tsx?");
...
eval("\r\n/**\r\n * @jest-environment jsdom\r\n */\r\nvar __createBinding = (this && this.__createBinding) || (Object.create ? (function(o, m, k, k2) {\r\n    if (k2 === undefined) k2 = k;\r\n    Object.defineProperty(o, k2, { enumerable: true, get: function() { return m[k]; } });\r\n}) : (function(o, m, k, k2) {\r\n    if (k2 === undefined) k2 = k;\r\n    o[k2] = m[k];\r\n}));\r\nvar __setModuleDefault = (this && this.__setModuleDefault) || (Object.create ? (function(o, v) {\r\n    Object.defineProperty(o, \"default\", { enumerable: true, value: v });\r\n}) : function(o, v) {\r\n    o[\"default\"] = v;\r\n});\r\nvar __importStar = (this && this.__importStar) || function (mod) {\r\n    if (mod && mod.__esModule) return mod;\r\n    var result = {};\r\n    if (mod != null) for (var k in mod) if (k !== \"default\" && Object.prototype.hasOwnProperty.call(mod, k)) __createBinding(result, mod, k);\r\n    __setModuleDefault(result, mod);\r\n    return result;\r\n};\r\nvar __importDefault = (this && this.__importDefault) || function (mod) {\r\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\r\n};\r\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\r\nexports.Dropdown = void 0;\r\nvar react_1 = __importStar(__webpack_require__(/*! react */ \"react\"));\r\nvar MenuItemsList_1 = __webpack_require__(/*! ../CardsList/Card/Menu/MenuItemsList */ \"./src/shared/CardsList/Card/Menu/MenuItemsList/index.ts\");\r\nvar displayTypeContext_1 = __webpack_require__(/*! ../context/displayTypeContext */ \"./src/shared/context/displayTypeContext.ts\");\r\nvar dropdown_less_1 = __importDefault(__webpack_require__(/*! ./dropdown.less */ \"./src/shared/Dropdown/dropdown.less\"));\r\nvar Text_1 = __webpack_require__(/*! ../Text/Text */ \"./src/shared/Text/Text.tsx\");\r\nvar react_dom_1 = __importDefault(__webpack_require__(/*! react-dom */ \"react-dom\"));\r\nfunction Dropdown(_a) {\r\n    var cardId = _a.cardId;\r\n    var displayType = (0, react_1.useContext)(displayTypeContext_1.displayTypeContext);\r\n    // React.useEffect(()=> setIsDropdownOpen(isOpen), [isOpen])\r\n    // React.useEffect(()=> isDropdownOpen ? onOpen() : onClose(), [isDropdownOpen])\r\n    var node = document.querySelector(\"#dropdown\" + cardId);\r\n    if (!node)\r\n        return null;\r\n    return react_dom_1.default.createPortal(react_1.default.createElement(\"div\", { className: dropdown_less_1.default.listContainer },\r\n        react_1.default.createElement(\"div\", { className: dropdown_less_1.default.list },\r\n            react_1.default.createElement(\"div\", { className: dropdown_less_1.default.dropdown },\r\n                react_1.default.createElement(MenuItemsList_1.MenuItemsList, { cardId: cardId, displayType: displayType.displayType }),\r\n                react_1.default.createElement(\"button\", { className: dropdown_less_1.default.closeButton },\r\n                    react_1.default.createElement(Text_1.Text, { mobileSize: 12, size: 14, color: Text_1.EColors.grey66 }, \"\\u0417\\u0430\\u043A\\u0440\\u044B\\u0442\\u044C\"))))), node);\r\n}\r\nexports.Dropdown = Dropdown;\r\n\n\n//# sourceURL=webpack://reactjscourse/./src/shared/Dropdown/Dropdown.tsx?");
...
eval("\r\nvar __importDefault = (this && this.__importDefault) || function (mod) {\r\n    return (mod && mod.__esModule) ? mod : { \"default\": mod };\r\n};\r\nObject.defineProperty(exports, \"__esModule\", ({ value: true }));\r\nexports.tokenContext = void 0;\r\nvar react_1 = __importDefault(__webpack_require__(/*! react */ \"react\"));\r\nexports.tokenContext = react_1.default.createContext('');\r\n\n\n//# sourceURL=webpack://reactjscourse/./src/shared/context/tokenContext.ts?");
